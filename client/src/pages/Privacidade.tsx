    ...
    content: (
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {[
            { type: "Essenciais", desc: "Necessários para o funcionamento básico da plataforma. Não podem ser desativados.", color: "bg-green-50 border-green-200" },
            { type: "Desempenho", desc: "Coletam informações sobre como os usuários utilizam a plataforma, de forma anônima e agregada.", color: "bg-blue-50 border-blue-200" },
            { type: "Funcionais", desc: "Permitem que a plataforma lembre suas preferências e configurações entre sessões.", color: "bg-gray-50 border-gray-200" },
          ].map(({ type, desc, color }) => (
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            ...
            <div key={right} className="flex gap-3 bg-white border border-gray-200 rounded-lg p-3">
              <div className="w-6 h-6 bg-blue-50 rounded flex items-center justify-center shrink-0 mt-0.5">
    ...
    content: (
      <div className="space-y-3">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <p className="text-sm font-semibold text-gray-800 mb-2">Canal de Privacidade</p>
    ...
    >
      ...
      <div className="space-y-6">
        {sections.map((section) => (
          ...
          >
            <h2 className="text-base font-bold text-gray-900 mb-4 flex items-center gap-3">
              <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center shrink-0">
                <section.icon className="w-4 h-4 text-gray-600" />
              </div>
              <span>
                <span className="font-mono text-gray-400 mr-1.5">{section.number}.</span>
                {section.title}
              </span>
            </h2>
            {section.content}
